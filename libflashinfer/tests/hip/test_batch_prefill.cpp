...
void _TestBatchRaggedPrefillKernelCorrectness(size_t num_kv_heads, size_t num_qo_heads,
  ...
  handler.Plan<DTypeQO, int32_t>((void*)float_buffer, float_workspace_size_in_bytes,
                                 ...
                                 /*total_num_rows=*/append_indptr.back(), batch_size, num_qo_heads,
                                 num_kv_heads, head_dim, /*page_size=*/1);

  auto status = BatchPrefillWithRaggedKVCacheWrapper<DTypeQO, DTypeKV, DTypeQO, int32_t>(
      &handler, queries_device, append_indptr_device, keys_device, values_device, kv_indptr_device,
...
// template <typename DTypeQO, typename DTypeKV>
// void _TestBatchPagedPrefillKernelShortContextCorrectness(size_t num_kv_heads, size_t
// num_qo_heads,
...
//   TestBatchPagedPrefillFP8KernelShortContextCorrectness<__hip_fp8_e4m3_fnuz>(false);
// }

// TEST(FlashInferCorrectnessTest, BatchPagedPrefillLongContextTestE4M3) {
//   TestBatchPagedPrefillFP8KernelLongContextCorrectness<__hip_fp8_e4m3_fnuz>(false);
// }
...
//   TestBatchPagedPrefillFP8KernelShortContextCorrectness<__hip_fp8_e5m2_fnuz>(false);
// }

// TEST(FlashInferCorrectnessTest, BatchPagedPrefillLongContextTestE5M2) {
//   TestBatchPagedPrefillFP8KernelLongContextCorrectness<__hip_fp8_e5m2_fnuz>(false);
// }
// #endif
