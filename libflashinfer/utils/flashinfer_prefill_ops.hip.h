...
hipError_t SinglePrefillWithKVCache(DTypeQ* q, DTypeKV* k, DTypeKV* v, DTypeO* o, DTypeO* tmp,
                                    ...
                                    uint32_t debug_thread_id = 0, uint32_t debug_warp_id = 0,
          ...
          {DISPATCH_head_dim(head_dim, HEAD_DIM,
                             {DISPATCH_pos_encoding_mode(pos_encoding_mode, POS_ENCODING_MODE, {
                               ...
                               Params params(q, k, v, /*custom_mask=*/nullptr, o, lse,
                                             /*alibi_slopes=*/nullptr, num_qo_heads, num_kv_heads,
                                             qo_len, kv_len, qo_stride_n, qo_stride_h, kv_stride_n,
                               ...
                               return SinglePrefillWithKVCacheDispatched<
                                   HEAD_DIM, HEAD_DIM, POS_ENCODING_MODE, USE_FP16_QK_REDUCTION,
                                   MASK_MODE, AttentionVariant, Params>(params, tmp, stream);
                             })})})});
  return hipSuccess;
}
