...
// HIP-compatible version of FlashInfer sampling kernels
// This file provides sampling implementations optimized for AMD GPUs with 64-thread wavefronts
#ifndef GPU_IFACE_SAMPLING_CUH_
#define GPU_IFACE_SAMPLING_CUH_
...
constexpr uint32_t SAMPLING_WARP_SIZE = gpu_iface::kWarpSize;
...
// HIP always has SubtractLeft available in hipcub
