...
hipError_t BatchPrefillFlatGatherDispatched(
    const DTypeQ* q, const DTypeKV* k_flat, const DTypeKV* v_flat, DTypeO* o,
    float* lse_scratch,
    const int32_t* qo_seqstarts, const int32_t* kv_seqstarts,
    int32_t batch, int32_t total_qo_len, int32_t total_kv_len,
    int32_t max_seqlen_q, int32_t num_qo_heads, int32_t num_kv_heads,
    int32_t q_stride_n, int32_t q_stride_h,
    int32_t k_stride_n, int32_t k_stride_h,
    int32_t v_stride_n, int32_t v_stride_h,
    float sm_scale, float logits_soft_cap,
    int32_t window_left,
    bool causal,
    const char* dtype_str, flashinfer::aiter::VariantKey::Dtype dtype_enum,
    hipStream_t stream) {
...
hipError_t BatchPrefillNativePagedDispatched(
    const DTypeQ* q, const DTypeKV* paged_k, const DTypeKV* paged_v, DTypeO* o,
    float* lse_scratch,
    const int32_t* qo_seqstarts,
    const int32_t* kv_indptr, const int32_t* kv_page_indices, const int32_t* kv_last_page_lens,
    int32_t batch, int32_t total_qo_len, int32_t max_seqlen_q,
    int32_t num_qo_heads, int32_t num_kv_heads,
    int32_t num_total_pages, int32_t page_size,
    int32_t q_stride_n, int32_t q_stride_h,
    ...
    int32_t k_stride_p, int32_t k_stride_h, int32_t k_batch_stride,
    int32_t v_stride_p, int32_t v_stride_h, int32_t v_batch_stride,
    float sm_scale, float logits_soft_cap,
    int32_t window_left,
    bool causal,
  ...
  using mha_batch_prefill_fn = float (*)(
      ::aiter::mha_batch_prefill_args,
      ::ck_tile::stream_config const&,
