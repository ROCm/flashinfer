...
def batch_prefill_with_paged_kv_cache_example(
    ...
    print("\nRunning Test ID: ", NUM_TESTS, " - Running configuration:")
    ...
    if all_passed:
        ...
        global NUM_FAILED
        NUM_FAILED += 1
        FAILED_TESTS_ID_LIST.append(NUM_TESTS)
...
if __name__ == "__main__":
    ...
    # Currently failing tests for AITER backend
    batch_prefill_with_paged_kv_cache_example(
        12, 54, 37, 1, 8, 8, 128, True, "NHD", "NONE", 0.0, False, True
    )
    
    # Disabling for AITER backend as AITER does not support HND layout
    # batch_prefill_with_paged_kv_cache_example(
    ...
    print(f"Failed tests IDs: {FAILED_TESTS_ID_LIST}")
    print("=" * 60)
